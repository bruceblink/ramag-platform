        ...
        window.open_dialog(cx, move |dialog, window, _app| {
            ...
            dialog
                ...
                .content(move |content, window, _| {
                    ...
                    content.child(
                        gpui_kit::div()
                            .debug_selector(|| "redis-value-edit-dialog-body".into())
                            .w_full()
                            .h(body_height)
                            .max_h(body_height)
                            .min_h_0()
    ...
    pub(super) fn open_list_element_dialog(
        ...
        window.open_dialog(cx, move |dialog, _w, _app| {
            ...
            dialog
                ...
                .w(px(640.0))
                .max_h(ramag_ui::responsive_dialog_max_height(_w))
                .margin_top(ramag_ui::responsive_dialog_top(_w))
                .p(px(24.0))
                .content(move |content, window, _| {
                    let body_height = (ramag_ui::responsive_dialog_max_height(window) - px(96.0))
                        .clamp(px(32.0), px(540.0));
...
#[cfg(test)]
#[path = "dialogs_value_render_test.rs"]
mod value_render_test;
