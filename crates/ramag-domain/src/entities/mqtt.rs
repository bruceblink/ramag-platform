...
pub const DEFAULT_MQTT_LOCAL_SERVER_HOST: &str = "127.0.0.1";
pub const DEFAULT_MQTT_LOCAL_SERVER_MAX_CONNECTIONS: u32 = 1024;
pub const MAX_MQTT_LOCAL_SERVER_HOST_BYTES: usize = 256;
pub const MAX_MQTT_LOCAL_SERVER_MAX_CONNECTIONS: u32 = 16_384;
