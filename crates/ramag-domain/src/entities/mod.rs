...
pub use kafka::{
    ...
    KafkaConfigUpdateOperation, KafkaConfigUpdateRequest, KafkaConsumerGroup,
    KafkaConsumerGroupMetrics, KafkaConsumerGroupOffset, KafkaConsumerMember,
    KafkaConsumerPartitionAssignment, KafkaMessageHeader, KafkaMessagePage, KafkaMessageQuery,
    KafkaMessageRecord, KafkaMessageSearchField, KafkaMessageSearchQuery, KafkaMessageTailEvent,
