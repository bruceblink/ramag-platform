...
use ramag_domain::{
    entities::{
        ...
        KafkaMessageRecord, KafkaMessageSearchField, KafkaMessageSearchMode,
        ...
        KafkaSchemaRegistryVersion, KafkaSecurityProtocol, KafkaTlsConfig, KafkaTopic,
        KafkaTopicCreateRequest, KafkaTopicPartitionExpansion, MAX_KAFKA_ACL_HOST_BYTES,
        MAX_KAFKA_ACL_RESOURCE_NAME_BYTES, MAX_KAFKA_BROKER_METRICS_PASSWORD_BYTES,
        MAX_KAFKA_BROKER_METRICS_USERNAME_BYTES, MAX_KAFKA_CONFIG_RESOURCE_NAME_BYTES,
        ...
        MAX_KAFKA_KSQLDB_ENDPOINT_BYTES, MAX_KAFKA_KSQLDB_QUERY_BYTES,
        MAX_KAFKA_METRICS_REFRESH_SECONDS, MAX_KAFKA_PARTITIONS, MAX_KAFKA_PRODUCE_MESSAGE_BYTES,
...
pub struct KafkaView {
    ...
    broker_metrics_username: Entity<InputState>,
    broker_metrics_password: Entity<InputState>,
    ...
    search_mode: KafkaMessageSearchMode,
