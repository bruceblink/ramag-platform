...
impl KafkaView {
    ...
    pub fn new(service: Arc<KafkaService>, window: &mut Window, cx: &mut Context<Self>) -> Self {
        ...
        subscriptions.push(
            cx.subscribe(&connect_search, |this, _, event: &InputEvent, cx| {
                if matches!(event, InputEvent::Change) {
                    this.connect_scroll
                        .0
                        .borrow()
        ...
        let mut this = Self {
            ...
            schema_selected_subject: None,
            schema_selected_version: None,
            schema_version_detail: None,
            schema_versions_scroll: ScrollHandle::new(),
            schema_version_detail_scroll: ScrollHandle::new(),
            schema_registry_cancelled: None,
            schema_registry_request_id: 0,
            schema_versions_cancelled: None,
            schema_versions_request_id: 0,
            schema_version_cancelled: None,
            schema_version_request_id: 0,
            loading_schema_subjects: false,
            schema_subjects_loaded: false,
            schema_subject_error: None,
            loading_schema_versions: false,
            schema_versions_error: None,
            loading_schema_version: false,
            schema_version_error: None,
            connect_connectors: Vec::new(),
            connect_search,
            connect_scroll: UniformListScrollHandle::new(),
