        ...
        let status_row = h_flex()
            ...
            .child(
                div()
                    ...
                    .when(!compact, |info| info.w(px(480.0)).flex_none())
                    .when(compact, |info| info.whitespace_normal())
                    .when(!compact, |info| info.whitespace_nowrap().truncate())
                    .text_xs()
