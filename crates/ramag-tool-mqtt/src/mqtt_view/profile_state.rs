impl MqttView {
    pub fn new(service: Arc<MqttService>, window: &mut Window, cx: &mut Context<Self>) -> Self {
        ...
        let mut view = Self {
            ...
            local_server_snapshot: None,
            local_server_snapshot_loading: false,
            local_server_snapshot_request_id: 0,
            local_server_snapshot_error: None,
            local_server_events: VecDeque::new(),
            local_server_event_cancelled: None,
            local_server_event_request_id: 0,
